...
[assembly: WebActivatorEx.PreApplicationStartMethod(
    typeof(SampleSitecoreProject.Web.App_Start.SitecoreMvcContrib.CastleWindsorActivator), "PreStart")]
...
namespace SampleSitecoreProject.Web.App_Start.SitecoreMvcContrib
{
    ...
    public static class CastleWindsorActivator
    {
        public static void PreStart() {
            ...
            var assembly = ReflectionUtil.GetAssemblyFromName("SampleSitecoreProject.Web");
